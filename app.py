...
api = Api(app,
          version='1.0',
          title='API for Rpi',
          description='RESTful API to control the GPIO pins of Raspbery Pi',
          doc='/docs')
...
pin_util = PinUtil()
pin_util.create({'pin_num': 18, 'color': 'red', 'state': 'off'})
pin_util.create({'pin_num': 17, 'color': 'green', 'state': 'off'})
pin_util.create({'pin_num': 27, 'color': 'blue', 'state': 'off'})
